...
/**
 * 保存答题进度到本地存储
 * @description 将当前答案数组保存到localStorage
 */
const saveProgress = () => {
 ...
 * 提交测试答案
 * @async
 * @description 将用户答案提交到服务器，包含用户信息和答案数据
 * @throws {Error} 网络请求失败或服务器返回错误时抛出
 */
